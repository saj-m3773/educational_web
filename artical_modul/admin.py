...
class ArticleCommentAdmin(admin.ModelAdmin):
    list_display = ['user', 'create_date', 'is_active', 'parent']


class ArticleُTagAdmin(admin.ModelAdmin):
    list_display = ['coption', 'is_activ']
    prepopulated_fields = {"slug": ["coption"]}


admin.site.register(models.ArticleCategory, ArticleCategoryAdmin)
admin.site.register(models.Article, ArticleAdmin)
admin.site.register(models.ArticleComment, ArticleCommentAdmin)
admin.site.register(models.ArticaleTag, ArticleُTagAdmin)
