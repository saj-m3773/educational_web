    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_descriptio', models.CharField(db_index=True, max_length=80, null=True, verbose_name='توضیحات کوتاه')),
                ('about_user', models.TextField(null=True, verbose_name='درباره شخص')),
                ('mobile', models.CharField(max_length=11, unique=True)),
                ('Resume_Link', models.CharField(blank=True, max_length=120, verbose_name='لینک رزومه')),
